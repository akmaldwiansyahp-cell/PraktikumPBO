...
public class Headphone extends PeriferalAudio{
    ...
    void checkLuas(){
        if (total > 25) {
            System.out.println("Ukuran foam headphone besar");
        }else if (total > 10) {
            System.out.println("Ukuran foam headphone sedang");
        } else {
            System.out.println("Ukuran foam headphone kecil");
        }
    }
